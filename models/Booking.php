...
class Booking extends Model
{
  ...
  public function createAndGetPaymentId($obj): null | array
  {
    ...
    if (!parent::create(
      ...
      error_log('booking not created successfully');
      return null;
    }
    ...
    return [
      'paymentId' => $paymentModel->createAndGetId($payment),
      'bookingId' => $bookingId
    ];
  }
  ...
  {
    parent::updateById($bookingId, ['booking_status' => 'approved']);
    
    $paymentModel = new Payment($this->conn);
    $paymentModel->updateById($paymentId, ['payment_status' => 'approved']);
  }
